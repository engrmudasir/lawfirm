...
export default function useQuestionnaires() {
    ...
    const getQuestionnaires = async () => {
        ...
        try {
            await store.dispatch('questionnaire/getQuestionnaires')
            .then((response) =>{
    ...
    const storeQuestionnaire = async (data) => {
        errors.value = ''
        try {
            await store.dispatch('questionnaire/createQuestionnaire', data)
            .then((response) =>{
    ...
    const updateQuestionnaire = async (id) => {
        errors.value = ''
        try {
            await store.dispatch('questionnaire/updateQuestionnaire', { id:id, questionnaire: questionnaire.value })
            .then((response) =>{
