"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["Role Update"],{
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./resources/js/views/Roles/Record.vue?vue&type=script&setup=true&lang=js":
/*!************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./resources/js/views/Roles/Record.vue?vue&type=script&setup=true&lang=js ***!
  \************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _composables_roles__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! @/composables/roles */ "./resources/js/composables/roles.js");
/* harmony import */ var _composables_permissions__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! @/composables/permissions */ "./resources/js/composables/permissions.js");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  setup: function setup(__props, _ref) {
    ...
    var titleStack = (0,vue__WEBPACK_IMPORTED_MODULE_1__.ref)(['Admin', 'Roles', 'Update']);

    var _useRoles = (0,_composables_roles__WEBPACK_IMPORTED_MODULE_16__["default"])(),
        errors = _useRoles.errors,
        role = _useRoles.role,
        rolePermissions = _useRoles.rolePermissions,
        updateRole = _useRoles.updateRole,
        getRole = _useRoles.getRole;

    var _usePermissions = (0,_composables_permissions__WEBPACK_IMPORTED_MODULE_17__["default"])(),
        permissions = _usePermissions.permissions,
        getPermissions = _usePermissions.getPermissions;

    (0,vue__WEBPACK_IMPORTED_MODULE_1__.onMounted)(getPermissions);
    (0,vue__WEBPACK_IMPORTED_MODULE_1__.onMounted)(getRole(props.id));
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.prev = 1;
                _context.next = 4;
                return updateRole(_objectSpread({}, form));
    ...
    (0,vue__WEBPACK_IMPORTED_MODULE_1__.watch)(role, function (newVal) {
    ...
    var __returned__ = {
      ...
      mdiAlertCircle: _mdi_js__WEBPACK_IMPORTED_MODULE_19__.mdiAlertCircle,
      mdiViewList: _mdi_js__WEBPACK_IMPORTED_MODULE_19__.mdiViewList,
      mdiAccount: _mdi_js__WEBPACK_IMPORTED_MODULE_19__.mdiAccount,
      mdiMail: _mdi_js__WEBPACK_IMPORTED_MODULE_19__.mdiMail,
      mdiFormTextboxPassword: _mdi_js__WEBPACK_IMPORTED_MODULE_19__.mdiFormTextboxPassword,
      ...
      useRoles: _composables_roles__WEBPACK_IMPORTED_MODULE_16__["default"],
      usePermissions: _composables_permissions__WEBPACK_IMPORTED_MODULE_17__["default"]
    };
    Object.defineProperty(__returned__, '__isScriptSetup', {
      enumerable: false,
      value: true
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/dist/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./resources/js/views/Roles/Record.vue?vue&type=template&id=453a3b22":
/*!*****************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/dist/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./resources/js/views/Roles/Record.vue?vue&type=template&id=453a3b22 ***!
  \*****************************************************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var _hoisted_1 = /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)("Update Role");
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ usePermissions)
/* harmony export */ });
/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime/regenerator */ "./node_modules/@babel/runtime/regenerator/index.js");
/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var vue__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! vue */ "./node_modules/vue/dist/vue.esm-bundler.js");
...
function usePermissions() {
  var permission = (0,vue__WEBPACK_IMPORTED_MODULE_1__.ref)([]);
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.prev = 1;
              _context.next = 4;
              return store.dispatch('permission/getPermissions').then(function (response) {
      ...
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              _context2.next = 2;
              return axios__WEBPACK_IMPORTED_MODULE_2___default().get("/api/permissions/".concat(id));
  ...
  var storePermission = /*#__PURE__*/function () {
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              _context3.prev = 1;
              _context3.next = 4;
              return store.dispatch('permission/createPermission', data).then(function (response) {
    ...
    return function storePermission(_x2) {
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              ...
              _context4.prev = 1;
              _context4.next = 4;
              return store.dispatch('permission/updatePermission', {
                id: id,
                permission: permission.value
              }).then(function (response) {
                console.log('response Updating Permission'); // console.log(response)
                ...
                console.log('error Updating Permissions'); // console.log(error)
  ...
  var destroyPermission = /*#__PURE__*/function () {
      ...
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee5$(_context5) {
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
              _context5.next = 2;
              return axios__WEBPACK_IMPORTED_MODULE_2___default()["delete"]("/api/permissions/".concat(id)).then(function (response) {
                $toast.show({
                  type: 'danger',
    ...
    return function destroyPermission(_x4) {
...
/***/ "./resources/js/views/Roles/Record.vue":
/*!*********************************************!*\
  !*** ./resources/js/views/Roles/Record.vue ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _Record_vue_vue_type_template_id_453a3b22__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Record.vue?vue&type=template&id=453a3b22 */ "./resources/js/views/Roles/Record.vue?vue&type=template&id=453a3b22");
/* harmony import */ var _Record_vue_vue_type_script_setup_true_lang_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Record.vue?vue&type=script&setup=true&lang=js */ "./resources/js/views/Roles/Record.vue?vue&type=script&setup=true&lang=js");
/* harmony import */ var _Users_mudasirmalik_Projects_Sites_lawfirm_node_modules_vue_loader_dist_exportHelper_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./node_modules/vue-loader/dist/exportHelper.js */ "./node_modules/vue-loader/dist/exportHelper.js");
...
;
const __exports__ = /*#__PURE__*/(0,_Users_mudasirmalik_Projects_Sites_lawfirm_node_modules_vue_loader_dist_exportHelper_js__WEBPACK_IMPORTED_MODULE_2__["default"])(_Record_vue_vue_type_script_setup_true_lang_js__WEBPACK_IMPORTED_MODULE_1__["default"], [['render',_Record_vue_vue_type_template_id_453a3b22__WEBPACK_IMPORTED_MODULE_0__.render],['__file',"resources/js/views/Roles/Record.vue"]])
/* hot reload */
if (false) {}
...
/***/ "./resources/js/views/Roles/Record.vue?vue&type=script&setup=true&lang=js":
/*!********************************************************************************!*\
  !*** ./resources/js/views/Roles/Record.vue?vue&type=script&setup=true&lang=js ***!
  \********************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./resources/js/views/Roles/Record.vue?vue&type=template&id=453a3b22":
/*!***************************************************************************!*\
  !*** ./resources/js/views/Roles/Record.vue?vue&type=template&id=453a3b22 ***!
  \***************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "render": () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_dist_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_dist_index_js_ruleSet_0_use_0_Record_vue_vue_type_template_id_453a3b22__WEBPACK_IMPORTED_MODULE_0__.render)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_dist_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_dist_index_js_ruleSet_0_use_0_Record_vue_vue_type_template_id_453a3b22__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../../node_modules/vue-loader/dist/templateLoader.js??ruleSet[1].rules[2]!../../../../node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./Record.vue?vue&type=template&id=453a3b22 */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/dist/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./resources/js/views/Roles/Record.vue?vue&type=template&id=453a3b22");
